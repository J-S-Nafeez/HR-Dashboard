...
const getRandomPerformanceHistory = (): Performance[] => {
  const projects = [
    "Project Alpha",
    "Project Beta",
    "Project Gamma",
...
export default function EmployeeDetailsPageClient({ id }: EmployeeDetailsPageClientProps) {
          ...
          <div>
            ...
            <ul>
              {user.performanceHistory.map((perf, index) => (
                <li key={index} className={`p-2 rounded mb-2 ${badgeColor(perf.rating)}`}>
